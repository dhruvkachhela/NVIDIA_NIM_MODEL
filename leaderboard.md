# NVIDIA NIM Evaluation Leaderboard

Created and Maintained by **[dhruvkachhela](https://github.com/dhruvkachhela)**.

This table is automatically updated by the automated weekly cron job. It displays performance ratings and latencies for all active models across various tasks.

## Coding Leaderboard

| Rank | Model Name | Score | Avg Latency |
| :--- | :--- | :--- | :--- |
